...
bigPhotoCloseBtn.addEventListener('click', onPopupClose);
...
uploadField.addEventListener('change', onUploadPopupOpen);
uploadPopupCloseBtn.addEventListener('click', onUploadPopupClose);
